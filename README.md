...
* [x] Specifically created to play one of the trailers (not teasers) from the database.
* [x] Forces landscape mode when playing the trailer.
...
![Walkthrough](FlicksterWalkthrough1.gif)
![Walkthrough](FlicksterWalkthrough2.gif)
![Walkthrough](FlicksterWalkthrough3.gif)
